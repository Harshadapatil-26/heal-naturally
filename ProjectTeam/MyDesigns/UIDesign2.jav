...
import javax.swing.*;
public class UIDesign2 extends JFrame
{
     JPanel PnlTop,PnlBottom,PnlSubTop,PnlLeft,PnlLeft2,PnlRight,PnlCenter,PnlButton,Pnl1,Pnl2,Pnl3,Pnl4,Pnl5,Pnl6,Pnl7,PnlLabel1,PnlLabel2;
     JButton Btn1,Btn2,Btn3,Btn4,Btn5,Btn6,Btn7;
     JComboBox cmb1,cmb2;
     JLabel lbl1,lbl2,lblimage;
     public UIDesign2()
     {
             setLayout(null);
             setSize(1920,1080);
             ...
             PnlLabel2=new JPanel();
			 PnlLabel2.setBounds(10,90,330,70);
			 PnlLabel2.setBackground(Color.white);
			 PnlLabel2.setLayout(null);
			 PnlLeft.add(PnlLabel2);
			 ...
			 PnlButton.setBackground(Color.cyan);
