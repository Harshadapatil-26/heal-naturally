...
import javax.swing.*;
public class UIDesign3 extends JPanel
{
     JPanel PnlTop,PnlBottom,PnlSubTop,PnlLeft,PnlLeft2,PnlRight,PnlCenter,PnlButton,PnlNew,PnlSave,PnlView,PnlEdit,PnlUpdate,PnlDelete,PnlCancel,Pnlcmb,Pnlcmb2,Pnlcmb3;
     JButton BtnNew,BtnSave,BtnView,BtnEdit,BtnUpdate,BtnDelete,BtnCancel;
     JComboBox cmb1,cmb2,cmb3;
     JLabel lblcmb,lblcmb2,lblcmb3,lblimage,lblTop,lblSubtop,lblBottom;
     public UIDesign3()
     {
             setLayout(null);
             setSize(1920,1080);
             ...
             PnlLeft2=new JPanel();
			 PnlLeft2.setBounds(10,250,330,570);
