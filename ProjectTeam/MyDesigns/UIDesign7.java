...
import javax.swing.*;
public class UIDesign7 extends JPanel
{
     JPanel PnlTop,PnlBottom,PnlSubTop,PnlLeft,PnlLeft2,PnlRight,PnlCenter,PnlButton,PnlNew,PnlSave,PnlView,PnlEdit,PnlUpdate,PnlDelete,PnlCancel,Pnlcmb,Pnlcmb2,Pnlcmb3,Pnlcmb4,Pnlcmb5,Pnlcmb6,Pnlcmb7;
     JButton BtnNew,BtnSave,BtnView,BtnEdit,BtnUpdate,BtnDelete,BtnCancel;
     JComboBox cmb1,cmb2,cmb3,cmb4,cmb5,cmb6,cmb7;
     JLabel lblcmb1,lblcmb2,lblcmb3,lblcmb4,lblcmb5,lblcmb6,lblcmb7,lblimage,lblTop,lblSubtop,lblBottom;
     public UIDesign7()
     {
             setLayout(null);
             setSize(1920,1080);
		     ...
		     lblSubtop.setBounds(850,10,400,30);
             ...
             Pnlcmb6=new JPanel();
			 Pnlcmb6.setBounds(10,410,330,70);
			 Pnlcmb6.setBackground(Color.white);
			 Pnlcmb6.setLayout(null);
			 PnlLeft.add(Pnlcmb6);

			 lblcmb6=new JLabel("Label 6");
			 lblcmb6.setBounds(20,20,80,30);
			 lblcmb6.setFont(new Font("Cambria",Font.BOLD,20));
			 Pnlcmb6.add(lblcmb6);

			 cmb6=new JComboBox();
			 cmb6.setBounds(110,20,200,30);
             Pnlcmb6.add(cmb6);

             Pnlcmb7=new JPanel();
			 Pnlcmb7.setBounds(10,490,330,70);
			 Pnlcmb7.setBackground(Color.white);
			 Pnlcmb7.setLayout(null);
			 PnlLeft.add(Pnlcmb7);

			 lblcmb7=new JLabel("Label 7");
			 lblcmb7.setBounds(20,20,80,30);
			 lblcmb7.setFont(new Font("Cambria",Font.BOLD,20));
			 Pnlcmb7.add(lblcmb7);

			 cmb7=new JComboBox();
			 cmb7.setBounds(110,20,200,30);
             Pnlcmb7.add(cmb7);


             PnlLeft2=new JPanel();
			 PnlLeft2.setBounds(10,570,330,250);
