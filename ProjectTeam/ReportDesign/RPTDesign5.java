...
public class RPTDesign5 extends JPanel
{
      JPanel pnlTop,pnlOption,pnlShow,pnlCancel,pnlSubOption1,pnlSubOption2,pnlSubOption3,pnlSubOption4,pnlSubOption5,pnlAction,pnlLeft,pnlRight,pnlCenterHeading,pnlCenter,pnlBottom;
      JLabel lblTop,lblSubOption1,lblSubOption2,lblSubOption3,lblSubOption4,lblSubOption5,lblLeftImage,lblRightImage,lblCenterHeading;
      JComboBox cmbSubOption1,cmbSubOption2,cmbSubOption3,cmbSubOption4,cmbSubOption5;
      ...
      public RPTDesign5()
      {
		   ...
		   pnlSubOption5=new JPanel();
		   pnlSubOption5.setBounds(1190,10,290,80);
		   pnlSubOption5.setBackground(Color.white);
		   pnlSubOption5.setLayout(null);
		   pnlOption.add(pnlSubOption5);

		   lblSubOption5=new JLabel("Label 5");
		   lblSubOption5.setBounds(100,5,100,30);
		   lblSubOption5.setFont(new Font("Cambria",Font.BOLD,20));
		   pnlSubOption5.add(lblSubOption5);

		   cmbSubOption5=new JComboBox();
		   cmbSubOption5.setBounds(20,40,250,30);
		   pnlSubOption5.add(cmbSubOption5);
